...
# 0.45 (было 0.40) — чуть заметнее ступенчатая моделировка тона кожи,
# ближе к «ручному арт»-стилю конкурента.
# 0.5+ — дизеринг становится заметен как текстура, может выглядеть как шум.
POTTS_LOCAL_DITHER_STRENGTH = 0.45
